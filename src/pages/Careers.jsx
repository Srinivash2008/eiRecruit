          ...
          <Card.Body>
            <form>
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" placeholder="Position you are applying for" required />
              </div>
              <div className="mb-3">
                <label className="form-label">Current Place of Stay</label>
                <input type="text" className="form-control" placeholder="Your current location" required />
              </div>
              <div className="mb-3">
                <label className="form-label">Preferred Country to Apply</label>
                <input type="text" className="form-control" placeholder="Preferred country" required />
              </div>
              <ButtonTwo label="Submit" to="#" />
            </form>
          </Card.Body>
        </Card>
      </motion.div>
